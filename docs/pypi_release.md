...
RaoRocketSim is packaged with `pyproject.toml` and publishes through GitHub
...
3. On TestPyPI, create a trusted publisher for:
   - PyPI project name: `RaoRocketSim`
...
python -m pip install --index-url https://test.pypi.org/simple/ \
  --extra-index-url https://pypi.org/simple/ RaoRocketSim
RaoRocketSim --help
```
